...
function preload(){
  ...
  backgroundImage = loadImage("trex background.jpg")
}

function setup() {
  createCanvas(windowWidth, windowHeight);
  trexBackground=createSprite(windowWidth/2,windowHeight/2)
  trexBackground.addImage(backgroundImage)
trexBackground.scale=3.5;
